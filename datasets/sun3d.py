...
class SUN3D:
    def __init__(self, data_dir='/home/fangbin/workspace/CATL/0-datasets/SUN3D', train=False):
...
if __name__ == "__main__":
    ...
    dataset = SUN3D(data_dir='/home/fangbin/workspace/CATL/0-datasets/SUN3D', train=False)
