...
class ARKit:
    def __init__(self, data_dir='/home/fangbin/workspace/CATL/0-datasets/ARKitScenes', train=False):
...
if __name__ == "__main__":
    ...
    dataset = ARKit(data_dir='/home/fangbin/workspace/CATL/0-datasets/ARKitScenes', train=False)
