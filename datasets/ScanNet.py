...
class ScanNet:
    def __init__(self, data_dir='/home/fangbin/workspace/CATL/0-datasets/ScanNet', train=False):
...
if __name__ == "__main__":
    ...
    dataset = ScanNet(data_dir='/home/fangbin/workspace/CATL/0-datasets/ScanNet', train=False)
