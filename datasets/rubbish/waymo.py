...
class Waymo:
    def __init__(self, data_dir='/home/fangbin/workspace/CATL/0-datasets/Waymo', train=False):
...
if __name__ == "__main__":
    ...
    dataset = Waymo(data_dir='/home/fangbin/workspace/CATL/0-datasets/Waymo', train=False)
